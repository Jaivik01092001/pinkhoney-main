...
function Chat() {
  ...
  const handleSendMessage = async () => {
    ...
    const newMessage = { text: input, time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }), sender: "user" };
    ...
    try {
      ...
      for (let i = 0; i < data.llm_ans.length; i++) {
        ...
        const botMessage = { text: data.llm_ans[i], time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }), sender: "bot" };
