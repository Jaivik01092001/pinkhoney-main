...
function Chat() {
    ...
    function handle_stripe(){
        router.push(`http://127.0.0.1:8080/create_checkout_session?user_id=${user_id}&selected_plan=${selectedPlan}&email=${email}`)
    }
  ...
  function go_to_home(){
    ...
    return (
        <>
        <div>
        <img onClick={go_to_home} className="w-full" src="/pricing_top.PNG" alt="Woman eating ice cream" />
        </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              <p className="text-2xl font-bold text-gray-900">{plan.price}</p>
                    ...
                    <button onClick={handle_stripe} className="sticky bottom-4 mt-1 w-full bg-pink-500 text-white text-lg font-bold py-3 rounded-lg shadow-md hover:bg-pink-600 transition duration-300">
