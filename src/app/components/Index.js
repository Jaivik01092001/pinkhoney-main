      ...
      <div className="bg-gradient-to-b">
        <div className="p-6 max-w-md mx-auto text-center space-y-6 pt-5">
          ...
          <p className="text-xl text-pink-200">
            Swipe and start matching with AI <br /> companions that listen, understand, <br /> and de-stress you.
          </p>
      ...
      <footer className="bg-footer-bg text-white py-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-purple-800">
            <p className="text-sm text-gray-400">© 2024 Pink Honey. All rights reserved.</p>
          </div>
        </div>
      </footer>
